...
class APIService {
  ...
  Future<List<Movie>> getMoviesByPerson({required int pageNumber,required personId}) async {
    Response response = await getData('/person/${personId}/movie_credits', params: {
      'page': pageNumber,
    });
