...
class DataRepository with ChangeNotifier {
  ...
  Future<List<Movie>> getPopularMoviesByPerson({required Person person}) async {
    try {
      List<Movie> movies = await apiService.getMoviesByPerson(pageNumber: _popularMoviePageIndex,personId: person.id);
      return movies;
    } on Response catch (response) {
      print("ERROR : ${response.statusCode}");
      rethrow;
